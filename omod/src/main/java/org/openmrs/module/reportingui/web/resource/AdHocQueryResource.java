...
package org.openmrs.module.reportingui.web.resource;
...
import org.openmrs.module.reportingui.adhoc.AdHocColumn;
import org.openmrs.module.reportingui.adhoc.AdHocDataSet;
import org.openmrs.module.reportingui.adhoc.AdHocParameter;
import org.openmrs.module.reportingui.adhoc.AdHocRowFilter;
import org.openmrs.module.reportingrest.util.ParameterUtil;
import org.openmrs.module.reportingui.web.AdHocRowFilterResults;
import org.openmrs.module.reportingui.web.controller.ReportingUiController;
 ...
 */
@Resource(name =  RestConstants.VERSION_1 + ReportingUiController.REPORTING_UI_NAMESPACE + "/adhocquery",
        supportedClass = AdHocDataSet.class, supportedOpenmrsVersions = {"1.8.*", "1.9.*", "1.10.*, 1.11.*", "1.12.*"})
